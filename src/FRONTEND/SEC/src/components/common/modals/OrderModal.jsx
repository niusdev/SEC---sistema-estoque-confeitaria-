  ...
  export default function OrderModal({ isOpen, onClose, receitasDisponiveis, onSave }) {
    const {
      register,
      control,
      handleSubmit,
    ...
    // Reseta formulário ao abrir o modal
    useEffect(() => {
      if (isOpen) {
        reset({
          nomeCliente: "",
      ...
      <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
        ...
        >
          <div className="flex justify-between items-start mb-4">
            <h2 className="text-xl font-bold">Cadastrar Pedido:</h2>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-3">
            <div>
              ...
              />
              {errors.nomeCliente && (
                <p className="text-red-600 mt-1 text-sm">{errors.nomeCliente.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.dataPedido && (
                <p className="text-red-600 mt-1 text-sm">{errors.dataPedido.message}</p>
              )}  
            </div>
